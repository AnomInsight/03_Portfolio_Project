// Cart state. This is business logic carried over from the original version
// unchanged on purpose: Version B is a visual alternative, not a different
// product. Item shape, id scheme, pricing and the change-notification contract
// are all identical.
const Cart = (() => {
  let items = [];
  const listeners = [];
